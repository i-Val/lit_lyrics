        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('dashboard.categories.store') }}" method="POST" class="mt-2">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group mb-2">
                                    <label for="name">Name</label>
                                    <input type="text" id="name" name="name" class="form-control" value="{{ old('name') }}" required maxlength="27">
                                </div>
                            </div>
